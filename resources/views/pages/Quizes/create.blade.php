                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('quize.store') }}" method="post" autocomplete="off">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="Grade_id">{{ trans('pages/quize.Subject') }}: <span class="text-danger">*</span></label>
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('pages/quize.Confirm
                                Data') }}</button>
                        </form>
                    </div>
                </div>
