...
@section('title')
    {{ trans('pages/payment.Check voucher') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
@section('PageTitle')
    {{ trans('pages/payment.Check voucher') }} {{ $student->name }}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('payment.store') }}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('pages/payment.Student balance:') }} </label>
                    ...
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right"
                        type="submit">{{ trans('pages/payment.submit') }}</button>
                </form>
