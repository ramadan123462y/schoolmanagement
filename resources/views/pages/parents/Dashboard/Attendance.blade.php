        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ url('parent/report') }}" autocomplete="off">
                        @csrf
                        <h6 style="font-family: 'Cairo', sans-serif;color: blue">
                            {{ trans('dashboardes/teacher.Information Searche') }} </h6><br>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="card-body datepicker-form">
                                <div class="input-group" data-date-format="yyyy-mm-dd">
                                    ...
                                    <x-inline-validation name="to"></x-inline-validation>
                        ...
                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right"
                            type="submit">{{ trans('dashboardes/teacher.submit') }}</button>
                    </form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($studentd->attendence_status == 0)
                                                    <span
                                                        class="btn-danger">{{ trans('dashboardes/teacher.Attendance') }}</span>
                                                @else
                                                    <span
                                                        class="btn-success">{{ trans('dashboardes/teacher.Absence') }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
