        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="col-xl-12 mb-30">
                                    ...
                                    <tbody>
                                        @foreach ($Fee_invoices as $Fee_invoice)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('invoice.edit', $Fee_invoice->id) }}"
                                                        class="btn btn-info btn-sm" role="button"
                                                        aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-toggle="modal" data-target="#Delete_Fee_invoice"
                                                        data-id="{{ $Fee_invoice->id }}"><i
                    ...
                    @include('pages.Students.Invoices_fees.delete')
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('#Delete_Fee_invoice').on('show.bs.modal', function(event) {
