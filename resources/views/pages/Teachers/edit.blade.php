...
@section('title')
    {{ trans('pages/teacher.Update_Teacher') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        <br>
                        <form action="{{ url('teacher/update_teacher') }}" method="post">
                            @csrf
                            <div class="form-row">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="password" value="{{ $teacher->Password }}" name="Password"
                                        class="form-control">
                                    @error('Password')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" value="{{ $teacher->getTranslation('Name', 'en') }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" value="{{ $teacher->Specialization_id }}"
                                        ...
                                        <option selected value="{{ $teacher->Specialization_id }}">
                                            {{ $teacher->specialization->Name }}
                                        </option>
                                        <option disabled>{{ trans('pages/teacher.Choose') }}...</option>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" value="{{ $teacher->Gender_id }}"
                                        name="Gender_id">
                                        <option selected value="{{ $teacher->Gender_id }}">
                                            {{ $teacher->gender->Name }}</option>
                                        <option disabled>{{ trans('pages/teacher.Choose') }}...</option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" value="{{ $teacher->Joining_Date }}" type="text"
                                            id="datepicker-action" name="Joining_Date" data-date-format="yyyy-mm-dd"
                                            required>
                                    </div>
                                    @error('Joining_Date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" value="{{ $teacher->Address }}" name="Address" id="exampleFormControlTextarea1"
                                    rows="4"></textarea>
                                @error('Address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
