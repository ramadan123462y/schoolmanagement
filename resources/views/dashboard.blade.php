...
<body style="font-family: 'Cairo', sans-serif">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{ url('student') }}"
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{ url('teacher') }}"
                                    target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{ url('parents') }}"
                                    target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{url('classroom')}}"
                                    target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-pane fade" id="teachers" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                @forelse(\App\Models\Teacher::latest()->take(3)->get() as $teacher)
                                                    <tbody>
                                                        <tr>
                                    ...
                                    <div class="tab-pane fade" id="parents" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\My_Parent::latest()->take(3)->get() as $parent)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\FeesInvoice::latest()->take(3)->get() as $section)
                                                        <tr>
 ...
 footer -->
    ...
    <script>
        window.addEventListener('eror_message', event => {
            //نفس العاديه
            toastr.options = {
                "closeButton": true,
                "progressBar": true
            }
            toastr.error("Please Refresh Badge To Drage");
